...
Date: 10/4/2022
Author: Caleb Barker
Desc: this File will run 4 tests on students nim players in order to check that
they are defining their
class and play function correctly. This checker also does some basic testing to
...
try:
    ...
    print("Test 2: Fail (Make sure that your class is named \'NimPlayer\')")
try:
    p1.play([1,2,3,4])
    print("Test 3: Pass ")
except :
